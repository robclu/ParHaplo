...
#ifndef PARAHAPLO_SMALL_CONTAINERS_H
#define PARAHAPLO_SMALL_CONTAINERS_H
...
public:
    ...
    // ------------------------------------------------------------------------------------------------------
    CUDA_H
    internal_container* start() { return thrust::raw_pointer_cast(&_data[0]); }
...
#endif      // PARAHAPLO_SMALL_CONTAINERS_H
